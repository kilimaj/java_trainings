...
public class HelloWorldImplServiceLocator extends org.apache.axis.client.Service implements soap.HelloWorldImplService {
    ...
    private java.lang.String HelloWorldImplPort_address = "http://localhost:7575/jaxws/welcome";
    ...
    public soap.HelloWorld getHelloWorldImplPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            soap.HelloWorldImplPortBindingStub _stub = new soap.HelloWorldImplPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (soap.HelloWorld.class.isAssignableFrom(serviceEndpointInterface)) {
                soap.HelloWorldImplPortBindingStub _stub = new soap.HelloWorldImplPortBindingStub(new java.net.URL(HelloWorldImplPort_address), this);
                _stub.setPortName(getHelloWorldImplPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://soap/", "HelloWorldImplService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://soap/", "HelloWorldImplPort"));
        }
